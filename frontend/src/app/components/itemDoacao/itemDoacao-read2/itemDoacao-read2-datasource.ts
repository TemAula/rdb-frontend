...
/**
 * Data source for the ItemDoacaoRead2 view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ItemDoacaoRead2DataSource extends DataSource<ItemDoacao> {
  data: ItemDoacao[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: ItemDoacao[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ItemDoacao[]) {
